 ...
 * function:
 */
public class MovieAttentionFragment extends BaseFragment implements IViewContract.doView {
    ...
    protected void initData() {
        ...
        persenter.doMOvieList(map, omap);
    }

    @Override
    public void onLogCurress(Object obj) {
        OnMovieBean onMovieBean = (OnMovieBean) obj;
        List<OnMovieBean.ResultBean> result = onMovieBean.result;
        MovieAttentionAdapter movieAdapter = new MovieAttentionAdapter(result);
