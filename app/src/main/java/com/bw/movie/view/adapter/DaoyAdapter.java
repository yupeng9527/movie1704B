 ...
 * function:
 */
public class DaoyAdapter extends XRecyclerView.Adapter<DaoyAdapter.MovieViewHolder> {
    List<DetilBean.ResultBean.MovieDirectorBean> resultBeanList;


    public DaoyAdapter(List<DetilBean.ResultBean.MovieDirectorBean> resultBeanList) {
    ...
    public void onBindViewHolder(@NonNull MovieViewHolder movieViewHolder, int i) {
        ...
        Glide.with(movieViewHolder.itemView.getContext())
                .load(resultBeanList.get(i).photo)
